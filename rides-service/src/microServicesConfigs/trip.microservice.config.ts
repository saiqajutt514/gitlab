import { KafkaOptions, Transport, TcpOptions, TcpClientOptions } from "@nestjs/microservices";
...
export const tripKafkaMicroServiceConfig: KafkaOptions = {
  ...
  options: {
    ...
    consumer: {
      groupId: 'trip-consumer-ts'  + '-' + Math.random(),
...
export const tripTCPMicroServiceConfig: TcpOptions & TcpClientOptions = {
