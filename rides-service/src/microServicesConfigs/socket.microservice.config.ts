...
export const socketMicroServiceConfig: KafkaOptions = {
  transport: Transport.KAFKA,

  options: {
    client: {
      clientId: 'socket-ts-service',
...
export const socketTCPConfig: ClientOptions = {
  transport: Transport.TCP,
  options: {
    host: appConfig().SocketTCPHost,
    port: Number(appConfig().SocketTCPPort),
  },
};
