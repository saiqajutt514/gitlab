...
export const formatDate = (dateVal: Date, format: string = 'yyyy-mm-dd') => {
  ...
  let moSort = new Intl.DateTimeFormat('en', { month: 'short' }).format(
    dateVal,
  );
...
/**
 * This function calculates DB format time from past,
 * for example you want to get time 30 mins ago.
 * @param minutesAgo : minutes
 * @returns time in this format 2022-12-30 10:07:59 (yyyy-mm-dd hh:mm:ss)
 */
export function getPastTime(minutesAgo: number) {
  ...
  // 👇️ 2022-12-30 10:07:59 (yyyy-mm-dd hh:mm:ss)
