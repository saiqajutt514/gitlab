...
export const tripKafkaMicroServiceConfig: KafkaOptions = {
  transport: Transport.KAFKA,

  options: {
    client: {
      clientId: "trip-cs-service",
...
export const tripTCPMicroServiceConfig: ClientOptions = {
  transport: Transport.TCP,
  options: {
    host: appConfig().TripTCPHost,
    port: Number(appConfig().TripTcpPort),
  },
};
