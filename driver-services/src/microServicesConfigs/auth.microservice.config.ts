...
export const authTCPMicroServiceConfig: ClientOptions = {
  transport: Transport.TCP,
  options: {
    host: appConfig().AuthTCPHost,
    port: Number(appConfig().AuthTcpPort),
  },
};
