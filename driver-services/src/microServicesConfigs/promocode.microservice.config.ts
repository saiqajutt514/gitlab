import { KafkaOptions, Transport, ClientOptions } from '@nestjs/microservices';
import appConfig from 'config/appConfig';

export const promoCodesKafkaMicroServiceConfig: KafkaOptions = {
  transport: Transport.KAFKA,
  options: {
    client: {
      clientId: 'promocode-ts-service',
...
export const promoCodesTCPMicroServiceConfig: ClientOptions = {
  transport: Transport.TCP,
  options: {
    host: appConfig().PromocodesTCPHost,
    port: Number(appConfig().PromoCodesTcpPort),
  },
};
